 ...
 * @license MIT
 */
import { perfContext, before, beforeEach, ThroughputRuntimeCase } from 'xterm-benchmark.mjs';

import { EscapeSequenceParser } from 'common/parser/EscapeSequenceParser.mjs';
import { C0, C1 } from 'common/data/EscapeSequences.mjs';
import { IDcsHandler, IOscHandler, IParams } from 'common/parser/Types.mjs';
import { OscHandler } from 'common/parser/OscParser.mjs';
import { DcsHandler } from '../../out/common/parser/DcsParser.mjs';
