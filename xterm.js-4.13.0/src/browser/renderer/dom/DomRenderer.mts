...
import { IRenderer, IRenderDimensions, IRequestRedrawEvent } from 'browser/renderer/Types.mjs';
import { BOLD_CLASS, ITALIC_CLASS, CURSOR_CLASS, CURSOR_STYLE_BLOCK_CLASS, CURSOR_BLINK_CLASS, CURSOR_STYLE_BAR_CLASS, CURSOR_STYLE_UNDERLINE_CLASS, DomRendererRowFactory } from 'browser/renderer/dom/DomRendererRowFactory.mjs';
import { INVERTED_DEFAULT_COLOR } from 'browser/renderer/atlas/Constants.mjs';
import { Disposable } from 'common/Lifecycle.mjs';
import { IColorSet, ILinkifierEvent, ILinkifier, ILinkifier2 } from 'browser/Types.mjs';
import { ICharSizeService } from 'browser/services/Services.mjs';
import { IOptionsService, IBufferService, IInstantiationService } from 'common/services/Services.mjs';
import { EventEmitter, IEvent } from 'common/EventEmitter.mjs';
import { color } from 'browser/Color.mjs';
import { removeElementFromParent } from 'browser/Dom.mjs';
