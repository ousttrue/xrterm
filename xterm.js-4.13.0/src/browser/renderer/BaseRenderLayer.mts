...
import { IRenderDimensions, IRenderLayer } from 'browser/renderer/Types.mjs';
import { ICellData } from 'common/Types.mjs';
import { DEFAULT_COLOR, WHITESPACE_CELL_CHAR, WHITESPACE_CELL_CODE, Attributes } from 'common/buffer/Constants.mjs';
import { IGlyphIdentifier } from 'browser/renderer/atlas/Types.mjs';
import { DIM_OPACITY, INVERTED_DEFAULT_COLOR } from 'browser/renderer/atlas/Constants.mjs';
import { BaseCharAtlas } from 'browser/renderer/atlas/BaseCharAtlas.mjs';
import { acquireCharAtlas } from 'browser/renderer/atlas/CharAtlasCache.mjs';
...
import { throwIfFalsy } from 'browser/renderer/RendererUtils.mjs';
import { channels, color, rgba } from 'browser/Color.mjs';
