...
import { ICharacterJoinerService, ICharSizeService, IMouseService, IRenderService, ISelectionService } from 'browser/services/Services.mjs';
import { IRenderDimensions, IRenderer, IRequestRedrawEvent } from 'browser/renderer/Types.mjs';
import { IColorSet, ILinkMatcherOptions, ITerminal, ILinkifier, ILinkifier2, IBrowser, IViewport, IColorManager, ICompositionHelper, CharacterJoinerHandler } from 'browser/Types.mjs';
import { IBuffer, IBufferStringIterator, IBufferSet } from 'common/buffer/Types.mjs';
import { IBufferLine, ICellData, IAttributeData, ICircularList, XtermListener, ICharset, ITerminalOptions } from 'common/Types.mjs';
...
import { IUnicodeService, IOptionsService } from 'common/services/Services.mjs';
