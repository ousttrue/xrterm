...
import { DIM_OPACITY } from 'browser/renderer/atlas/Constants.mjs';
import { IRasterizedGlyph, IBoundingBox, IRasterizedGlyphSet } from '../Types.mjs';
import { DEFAULT_COLOR, Attributes } from 'common/buffer/Constants.mjs';
...
import { channels, rgba } from 'browser/Color.mjs';
